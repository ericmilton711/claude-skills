...
<body>
  ...
  function camBase(){var h=window.location.hostname;if(h.match(/^192\.168\./))return{video:'http://192.168.12.212:8080/',audio:'http://192.168.12.212:8081/'};return{video:'http://100.70.179.60:8241/',audio:'http://100.70.179.60:8242/'};}
